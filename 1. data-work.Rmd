...
no_females <- count ( data [ which ( data$sex == 2 ) , ] ) # 95/415 females approx 23%
...
data <- data %>% select(X1, earnwke, uhours, grade92, age, ind02, occ2012, female, h_wage, lnw, ed_MA, ed_Profess, ed_PhD)
