...
datasummary( earnwke ~ Mean + SD + Min + 
               Max + Median + P95 + N , data = final_data )


female <- final_data %>% group_by(female) %>% 
            dplyr:: summarize(Eprice_cat2=mean(earnwke))
final_data <-left_join(final_data,female)
